...
def get_parser():
    ...
    ## renderer
    parser.add_argument('--mode',  type=str,  default='single_view_txt', help="Supported modes: 'single_view_txt', 'single_view_target', 'single_view_autotraj'")
    ...
    parser.add_argument('--planner_loop_back', type=bool, default=True, help='Whether planner should return to origin at the last keyframe')
    ...
    ## WAVE-style frequency domain parameters for stable background
    parser.add_argument('--use_freq_mix', type=bool, default=True, help='Enable WAVE-style FFT frequency mixing for PANI (recommended)')
    ...
    parser.add_argument('--low_freq_norm', type=bool, default=True, help='Normalize low-frequency components (key for stability)')
    parser.add_argument('--noise_level', type=int, default=999, help='Noise level for forward diffusion in PANI (WAVE uses 999)')
