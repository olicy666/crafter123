...
class FrozenOpenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, arch="ViT-H-14", version="laion2b_s32b_b79k", device="cuda", max_length=77,
        ...
        super().__init__()
        assert layer in self.LAYERS
        model, _, _ = open_clip.create_model_and_transforms(arch, device=torch.device('cpu'), pretrained='./checkpoints/open_clip_model/open_clip_pytorch_model.bin')
        del model.visual
        self.model = model
...
class FrozenOpenCLIPImageEmbedder(AbstractEncoder):
    ...
    def __init__(self, arch="ViT-H-14", version="laion2b_s32b_b79k", device="cuda", max_length=77,
        ...
        model, _, _ = open_clip.create_model_and_transforms(arch, device=torch.device('cpu'),
                                                            pretrained='./checkpoints/open_clip_model/open_clip_pytorch_model.bin', )
